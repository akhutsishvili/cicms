...
class Cms extends CI_Controller {
    ...
    /*
      function maillist(){
      $data['tables']=$this->core_m->table_list($this->config->item('table','label'));
      $config = array (
      'mailtype' => 'html',
      'charset'  => 'utf-8',
      'priority' => '1'
      ...
      $this->load->view('cms/cms_header',$data);
      $this->load->view('cms/maillist');
      $this->load->view('cms/cms_footer');
      }
    */
    ...
    function test(){
	$res = $this->db->query("DESCRIBE items")->result_array();
	pre($res);
	foreach($res as $r){
	    echo $r['Field'].br();
	}
